...
class QuranModel {
  ...
  @override
  String toString() {
    return 'QuranModel(id: $id, name: $name, nameEn: $nameEn, nameTranslation: $nameTranslation, words: $words, letters: $letters, type: $type, typeEn: $typeEn, ar: $ar, en: $en, array: $array)';
  }
